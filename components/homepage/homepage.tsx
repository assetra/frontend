  ...
  return (
    <div className="flex flex-col w-screen px-7 bg-[#000] h-screen text-white">
      ...
      <p className="text-center max-w-[500px] mx-auto text-sm mt-4">
        Stay informed about the most recent developments in the cryptocurrency sector and maintain a competitive edge in
        the market.
      </p>
      <div className="flex gap-4 mx-auto border-2 border-slate-500 px-4 py-2 mt-10 rounded-[100px] bg-[#141212]">
        <input className="bg-transparent h-full outline-none" placeholder="Enter your email address" />
        <button className="bg-[#1E68F6] text-white p-2 rounded-[100px]">Get Started</button>
      </div>
      ...
      <div>
        <div>
          <h3>WHAT IS GTX?</h3>
          <p>
            "GTX simplifies crypto for all. Our user-friendly ecosystem eases blockchain interactions, catering to
            novices and experts alike. We're dedicated to creating intuitive tools, making crypto investment accessible
            and efficient."
          </p>
        </div>
        <div>
          <h3>OUR MISSION</h3>
          <p>
            Our goal is to empower people to participate in the exciting world of cryptocurrencies with confidence and
            ease, and to help bridge the gap between traditional finance and the emerging digital economy.
          </p>
        </div>
      </div>
      <div>

...
export const ReferralPop: React.FC = () => {
  const { user } = useAuth();
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://gtx.pythonanywhere.com/referrals/user",
          {
            method: "POST",
            headers: {
  ...
  return (
    <>
      <input type="checkbox" id="referral" className="modal-toggle" />
      <div className="modal" role="dialog">
        <div className="modal-box min-w-[90svw] md:overflow-hidden overflow-y-scroll">
          <label
            htmlFor="referral"
          ...
          <div className="w-full grid px-6">
              ...
              >
                ...
                <ul className="m-0 pl-5">
                  ...
                  <li className="mb-[10px]">
                    ...
                    You both earn rewards when they complete their first
                    transaction!
                  </li>
                </ul>
              </div>
              <div className="m-auto relative pl-6">
                ...
                <div className="flex justify-between gap-4 mb-4">
                  <div className="flex bg-base-content text-base-200 rounded-md h-12 px-6 w-full max-w-[500px] overflow-hidden">
                    <p className="my-auto text-lg overflow-hidden">
                      {referralLink}
                    </p>
                  </div>
                  <button
            ...
            <p className="mt-4 m-auto">
              Please note that some Terms & Conditions apply. Your friends will
              need to verify their identity before any rewards are given to your
              account.
            </p>
          </div>

          <div className="modal-action justify-center -mt-2"></div>
        </div>
      </div>
    </>
  );

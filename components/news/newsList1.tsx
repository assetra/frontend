...
const NewsList1: React.FC<ArticleListProps> = ({ articles }) => {
    ...
    <div className="grid grid-cols-4 grid-rows-4 gap-4 mt-4">
      {getArticle(0) && (
        <div className="col-span-2 row-span-1 rounded-md shadow-inner p-2 relative">
          <div
            ...
            style={{ backgroundImage: `url(${articles[0]?.cover_image})` }}
          ></div>
      ...
      {getArticle(1) && (
        ...
        >
          ...
          <h6 className="h6 line-clamp-2 mt-2 pr-2">{articles[1]?.title}</h6>
          <p
      ...
      {getArticle(2) && (
        <a
          className="row-span-2 bg-white rounded-md shadow-inner p-2"
        ...
        >
          ...
          <h6 className="h6 line-clamp-3 mt-2 pr-2">{articles[2]?.title}</h6>
          <p
      ...
      {getArticle(4) && (
        ...
        >
          <img
            src={articles[4]?.cover_image}
            className="w-full h-1/2 object-cover rounded-lg"
            alt={articles[4]?.title}
          />
          <p className="mt-2">
            <DateFormatter datetime={articles[4]?.created_at} />
          </p>
      ...
      {getArticle(6) && (
        <div className="col-span-2 row-span-2 rounded-md shadow-inner p-2 relative">
          <div
            className="absolute inset-0 bg-cover bg-center rounded-md"
            style={{ backgroundImage: `url(${articles[6]?.cover_image})` }}
          ></div>

    ...
    <div className="flex min-h-screen pt-12">
      <div className="w-full md:w-[80svw] p-6 rounded-md bg-base-300 m-auto">
        ...
        <p className="mb-[10px] leading-7">
          Welcome to Assetra! By accessing and using our digital asset
          ecosystem, including our cryptocurrency exchange, NFT marketplace, and
        ...
        <ul className="m-0 pl-5">
          <li className="mb-[10px]">
            ...
            Antigua and Barbuda, where Assetra is headquartered. You are
          ...
          <li className="mb-[10px]">
            ...
            While Assetra strives to provide reliable and uninterrupted
            services, we do not guarantee continuous availability. We reserve
          ...
          <li className="mb-[10px]">
            ...
            Assetra may suspend or terminate your access to our services if we
            suspect fraudulent activity, violations of our terms of service, or
            for any other reason at our discretion. You agree that Assetra shall
            not be liable for any losses or damages resulting from such actions.
          </li>
          <li className="mb-[10px]">
          ...
          <li className="mb-[10px]">
            ...
            In no event shall Assetra, its affiliates, directors, officers,

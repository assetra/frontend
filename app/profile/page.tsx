...
function profilepage() {
  return (
    <div className="ml-10 bg-[#000] w-[100svw] h-[100svh] pt-24  overflow-hidden">
      ...
      <div className="flex flex-col px-10 py-6 mt-2 w-[75svw] h-[75svh] rounded-xl bg-[#1E1F25] max-md:px-5 max-md:max-w-full">
        <form action="" className="">
          ...
          <div className="grid grid-cols-6 mt-3">
            ...
            <button className="col-end-7 col-span-1 py-0.5 bg-red-500 rounded-full">
              Delete Account Now
            </button>
          </div>

          <div className="flex justify-end mt-3">
          <button className="px-12 py-3.5 text-base font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 rounded-full">
            Save Changes
            </button>
          </div>

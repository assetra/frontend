...
const Wallet = () => {
  ...
  useEffect(() => {
    ...
    appContext.setDashboardState(3);
  }, []);
          ...
          <div className="flex flex-col w-full rounded-xl mb-2 lg:mb-6 px-2 lg:px-6 py-4 border-2 border-[#246CF9]">
            <div className="flex flex-row justify-between items-center mb-6">
              <div className="flex flex-row">
                <Image src="/images/market-icon/BTC.png" alt="BTC" width={24} height={24} />
                <div className="px-5 text-white">BTC</div>
              </div>
              <div className="text-[#11CABE]">0.25%</div>
            </div>
            <div className=" text-[20px] lg:text-[25px] text-white">0.2133214214</div>
            <div className="text-[#A5ADCF]  text-sm lg:text-base">3,230.98 USD</div>
            <div className="">
              <Image src="/images/wallet-icon/BTC.png" alt="BTC" width={272} height={72} />
            </div>
          </div>
          <div className="flex flex-col w-full rounded-xl mb-2 lg:mb-6 px-2 lg:px-6 py-4 bg-[#1E1F25]">
            <div className="flex flex-row justify-between items-center mb-6">
              <div className="flex flex-row">
                <Image src="/images/market-icon/ETH.png" alt="BTC" width={24} height={24} />
                <div className="px-5 text-white">ETH</div>
              </div>
              <div className="text-[#FA2256]">0.12%</div>
            </div>
            <div className=" text-[20px] lg:text-[25px] text-white">0.3454364</div>
            <div className="text-[#A5ADCF] text-sm lg:text-base">2,345.21 USD</div>
            <div>
              <Image src="/images/wallet-icon/ETH.png" alt="BTC" width={272} height={72} />
            </div>
          </div>
          <div className="flex flex-col w-full rounded-xl mb-2 lg:mb-6 px-2 lg:px-6 py-4 bg-[#1E1F25]">
            <div className="flex flex-row justify-between items-center mb-6">
              <div className="flex flex-row">
                <Image src="/images/market-icon/USDT.png" alt="BTC" width={24} height={24} />
            ...
            <div className="text-[#A5ADCF] text-sm lg:text-base">2,345.21 USD</div>
            <div>
              <Image src="/images/wallet-icon/USDT.png" alt="BTC" width={272} height={72} />
            </div>
          </div>
          <div className="flex flex-col justify-center w-full rounded-xl border-2 border-[#34384C] border-dashed">
            <button className="flex justify-center">
              <Image src="/images/wallet-icon/Add Button.png" width={93} height={93} alt="ADD" />
            </button>
            <div className="flex justify-center text-[#A5ADCF] mt-2">Add New Wallet</div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-row w-full  bg-[#1E1F25] rounded-xl mb-2 lg:mb-6 p-2 lg:p-8">
          <div className="flex flex-col justify-betw een w-2/5 h-full border-r-[1px] border-[#34384C]">
            <div className="flex flex-row items-center pb-4">
              <Image src="/images/wallet-icon/Bitcoin.png" width={32} height={32} alt="BTC" />
              <div className="text-white mx-3 ">{selectedSummary.type}</div>
            </div>
            <div className="text-[#5D6588] text-base">{selectedSummary.description}</div>
            <div className="text-white text-[26px] lg:text-[39px]">{selectedSummary.price}</div>
            ...
            <div className="flex flex-col lg:flex-row text-white text-[14px] items-center gap-x-3 gap-y-3  w-full">
              ...
              <button className="rounded-full border-2 px-6 py-3 text-[14px]/[22.4px]">Deposit</button>
            </div>
          </div>
          <div className="flex flex-col w-3/5 h-full pl-[20px] lg:pl-[68px] ">
            <div className="flex flex-col w-full h-1/2 p-2 ">
              <div className="flex flex-row justify-between w-full h-full">
                <div className="flex flex-col h-full">
                  <div className="text-[#5D6588] text-base">Exchange Balance</div>
                  <div className="text-white text-[25px]">0.213435345</div>
                  <div className="text-[#11CABE] text-[18px]">3,897.98 USD</div>
                </div>
                <div className="flex flex-col justify-end h-full">
                  <Image src="/images/exchange-graph-0.png" width={156} height={40} alt="Graph" />
            ...
            <div className="flex flex-col w-full h-1/2 p-2 ">
              <div className="flex flex-row justify-between w-full h-full">
                ...
                <div className="flex flex-col justify-end  h-full">
                  <Image src="/images/exchange-graph-1.png" width={156} height={40} alt="Graph" />
